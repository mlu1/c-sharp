...
class Program
{
    static void Main(string[] args)
    {
        ...
        List<(string testCase, bool expectedResult)> testCases = new()
        {
            ...
            ("<root/>",                                        true),  // single self-closing tag
            ("<tutorial date=\"01/01/2000\">XML</tutorial>",    false), // closing tag lacks attributes
            ("<tag>>",                                        false),  // extra '>'
            ("<img src=\"pic.jpg\"></img src=\"pic.jpg\">",    true),
            ("<br/><hr/><hr/>",                                true),  // sequence of self-closing tags
            ("<p data=\"1\"></p data='1'>",                     false),
            ("<",                                             false),  // lone '<'
            (">",                                             false),  // lone '>'
            ("<a><b><c></c></b></a>",                          true),  // deep-nesting OK
